...
public final class Literals {
    ...
    public static final String ERROR_STATISTIC = "Ошибка в статистике";
    public static final String NOT_CREATE_FILE = "Нельзя создать  файлы в директории: ";
    public static final String CREATE_FILE = "Файлы будут созданы в корневой директории проекта: ";
